...
import {
  ...
  Device,
  LivestreamNotRunningError as EufyLivestreamNotRunningError,
  LivestreamAlreadyRunningError as EufyLivestreamAlreadyRunningError,
  InvalidPropertyError as EufyInvalidPropertyError,
  PropertyNotSupportedError as EufyPropertyNotSupportedError,

...
export const dumpStationProperties = (
  station: Station,
  ...
  const base: StationPropertiesSchema0 = {
    ...
    timeFormat: station.getPropertyValue(
      PropertyName.StationTimeFormat,
    ) as number,
    alarmVolume: station.getPropertyValue(
      PropertyName.StationAlarmVolume,
    ) as number,
    alarmTone: station.getPropertyValue(
      PropertyName.StationAlarmTone,
    ) as number,
    promptVolume: station.getPropertyValue(
      PropertyName.StationPromptVolume,
    ) as number,
    notificationSwitchModeSchedule: station.getPropertyValue(
      PropertyName.StationNotificationSwitchModeSchedule,
    ) as boolean,
    notificationSwitchModeGeofence: station.getPropertyValue(
      PropertyName.StationNotificationSwitchModeGeofence,
    ) as boolean,
    notificationSwitchModeApp: station.getPropertyValue(
      PropertyName.StationNotificationSwitchModeApp,
    ) as boolean,
    notificationSwitchModeKeypad: station.getPropertyValue(
      PropertyName.StationNotificationSwitchModeKeypad,
    ) as boolean,
    notificationStartAlarmDelay: station.getPropertyValue(
      PropertyName.StationNotificationStartAlarmDelay,
    ) as boolean,
    switchModeWithAccessCode: station.getPropertyValue(
      PropertyName.StationSwitchModeWithAccessCode,
    ) as boolean,
    autoEndAlarm: station.getPropertyValue(
      PropertyName.StationAutoEndAlarm,
    ) as boolean,
    turnOffAlarmWithButton: station.getPropertyValue(
      PropertyName.StationTurnOffAlarmWithButton,
    ) as boolean,
    stationHomeSecuritySettings: station.getPropertyValue(
      PropertyName.StationHomeSecuritySettings,
    ) as string,
    stationAwaySecuritySettings: station.getPropertyValue(
      PropertyName.StationAwaySecuritySettings,
    ) as string,
    stationCustom1SecuritySettings: station.getPropertyValue(
      PropertyName.StationCustom1SecuritySettings,
    ) as string,
    stationCustom2SecuritySettings: station.getPropertyValue(
      PropertyName.StationCustom2SecuritySettings,
    ) as string,
    stationCustom3SecuritySettings: station.getPropertyValue(
      PropertyName.StationCustom3SecuritySettings,
    ) as string,
    stationOffSecuritySettings: station.getPropertyValue(
  ...
  stationProperties1.alarm = station.getPropertyValue(
    PropertyName.StationAlarm,
  ) as boolean;
  stationProperties1.alarmType = station.getPropertyValue(
    PropertyName.StationAlarmType,
  ) as number;
  stationProperties1.alarmArmed = station.getPropertyValue(
    PropertyName.StationAlarmArmed,
  ) as boolean;
  stationProperties1.alarmArmDelay = station.getPropertyValue(
    PropertyName.StationAlarmArmDelay,
  ) as number;
  stationProperties1.alarmDelay = station.getPropertyValue(
    PropertyName.StationAlarmDelay,
  ) as number;
  stationProperties1.alarmDelayType = station.getPropertyValue(
    PropertyName.StationAlarmDelayType,
  ) as number;
  ...
  stationProperties2.storageInfoEmmc = station.getPropertyValue(
    PropertyName.StationStorageInfoEmmc,
  ) as object;
  ...
  stationProperties2.continuousTrackingTime = station.getPropertyValue(
    PropertyName.StationContinuousTrackingTime,
  ) as number;
  stationProperties2.trackingAssistance = station.getPropertyValue(
    PropertyName.StationTrackingAssistance,
  ) as boolean;
  stationProperties2.crossTrackingCameraList = station.getPropertyValue(
    PropertyName.StationCrossTrackingCameraList,
  ) as object;
  stationProperties2.crossTrackingGroupList = station.getPropertyValue(
...
export const dumpStationPropertiesMetadata = (
  station: Station,
  schemaVersion: number,
): IndexedProperty => {
  ...
  const result: IndexedProperty = {
    ...
    notificationSwitchModeSchedule:
      metadata[PropertyName.StationNotificationSwitchModeSchedule],
    notificationSwitchModeGeofence:
      metadata[PropertyName.StationNotificationSwitchModeGeofence],
    notificationSwitchModeApp:
      metadata[PropertyName.StationNotificationSwitchModeApp],
    notificationSwitchModeKeypad:
      metadata[PropertyName.StationNotificationSwitchModeKeypad],
    notificationStartAlarmDelay:
      metadata[PropertyName.StationNotificationStartAlarmDelay],
    switchModeWithAccessCode:
      metadata[PropertyName.StationSwitchModeWithAccessCode],
    autoEndAlarm: metadata[PropertyName.StationAutoEndAlarm],
    turnOffAlarmWithButton:
      metadata[PropertyName.StationTurnOffAlarmWithButton],
    ...
    custom1SecuritySettings:
      metadata[PropertyName.StationCustom1SecuritySettings],
    custom2SecuritySettings:
      metadata[PropertyName.StationCustom2SecuritySettings],
    custom3SecuritySettings:
      metadata[PropertyName.StationCustom3SecuritySettings],

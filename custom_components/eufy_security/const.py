...
class Schema(Enum):
    ...
    QUICK_RESPONSE_SERVICE_SCHEMA = make_entity_service_schema(
        {vol.Required("voice_id"): cv.Number}
    )
    CHIME_SERVICE_SCHEMA = make_entity_service_schema(
        {vol.Required("ringtone"): cv.Number}
    )
...
class PropertyToEntityDescription(Enum):
    ...
    batteryTemperature = EntityDescription(
        id=auto(),
        device_class=SensorDeviceClass.TEMPERATURE,
        category=EntityCategory.DIAGNOSTIC,
    )
    lastChargingDays = EntityDescription(
        id=auto(), unit="d", category=EntityCategory.DIAGNOSTIC
    )
    wifiRssi = EntityDescription(
        id=auto(),
        device_class=SensorDeviceClass.SIGNAL_STRENGTH,
        category=EntityCategory.DIAGNOSTIC,
    )
    wifiSignalLevel = EntityDescription(
        id=auto(), icon="mdi:signal", category=EntityCategory.DIAGNOSTIC
    )
    personName = EntityDescription(id=auto(), icon="mdi:account-question")
    rtspStreamUrl = EntityDescription(
        id=auto(), icon="mdi:movie", category=EntityCategory.DIAGNOSTIC
    )
    chargingStatus = EntityDescription(
        id=auto(), icon="mdi:ev-station", category=EntityCategory.DIAGNOSTIC
    )
    ...
    doorSensor1BatteryLevel = EntityDescription(
        id=auto(),
        state_class=SensorStateClass.MEASUREMENT,
        category=EntityCategory.DIAGNOSTIC,
    )
    doorSensor2BatteryLevel = EntityDescription(
        id=auto(),
        state_class=SensorStateClass.MEASUREMENT,
        category=EntityCategory.DIAGNOSTIC,
    )
    ...
    motionDetected = EntityDescription(
        id=auto(), device_class=BinarySensorDeviceClass.MOTION
    )
    personDetected = EntityDescription(
        id=auto(), device_class=BinarySensorDeviceClass.MOTION
    )
    petDetected = EntityDescription(
        id=auto(), device_class=BinarySensorDeviceClass.MOTION
    )
    soundDetected = EntityDescription(
        id=auto(), device_class=BinarySensorDeviceClass.SOUND
    )
    cryingDetected = EntityDescription(
        id=auto(), icon="mdi:emoticon-cry", device_class=BinarySensorDeviceClass.SOUND
    )
    sensorOpen = EntityDescription(id=auto(), device_class=BinarySensorDeviceClass.DOOR)
    batteryLow = EntityDescription(
        id=auto(), device_class=BinarySensorDeviceClass.BATTERY
    )
    ringing = EntityDescription(
        id=auto(), icon="mdi:bell-ring", device_class=BinarySensorDeviceClass.RUNNING
    )
    notificationPerson = EntityDescription(
        id=auto(), icon="mdi:message-badge", category=EntityCategory.CONFIG
    )
    notificationPet = EntityDescription(
        id=auto(), icon="mdi:message-badge", category=EntityCategory.CONFIG
    )
    notificationAllOtherMotion = EntityDescription(
        id=auto(), icon="mdi:message-badge", category=EntityCategory.CONFIG
    )
    notificationCrying = EntityDescription(
        id=auto(), icon="mdi:message-badge", category=EntityCategory.CONFIG
    )
    notificationAllSound = EntityDescription(
        id=auto(), icon="mdi:message-badge", category=EntityCategory.CONFIG
    )
    identityPersonDetected = EntityDescription(
        id=auto(), category=EntityCategory.DIAGNOSTIC
    )
    strangerPersonDetected = EntityDescription(
        id=auto(), category=EntityCategory.DIAGNOSTIC
    )
    ...
    radarMotionDetected = EntityDescription(
        id=auto(), category=EntityCategory.DIAGNOSTIC
    )
    ...
    doorSensor1LowBattery = EntityDescription(
        id=auto(),
        device_class=BinarySensorDeviceClass.BATTERY,
        category=EntityCategory.DIAGNOSTIC,
    )
    doorSensor2LowBattery = EntityDescription(
        id=auto(),
        device_class=BinarySensorDeviceClass.BATTERY,
        category=EntityCategory.DIAGNOSTIC,
    )
    ...
    antitheftDetection = EntityDescription(
        id=auto(), icon="mdi:key", category=EntityCategory.CONFIG
    )
    autoNightvision = EntityDescription(
        id=auto(), icon="mdi:lightbulb-night", category=EntityCategory.CONFIG
    )
    statusLed = EntityDescription(
        id=auto(), icon="mdi:alarm-light-outline", category=EntityCategory.CONFIG
    )
    ...
    cryingDetection = EntityDescription(
        id=auto(), icon="mdi:emoticon-cry", category=EntityCategory.CONFIG
    )
    chimeIndoor = EntityDescription(
        id=auto(), icon="mdi:bell-ring", category=EntityCategory.CONFIG
    )
    motionTracking = EntityDescription(
        id=auto(), icon="mdi:radar", category=EntityCategory.CONFIG
    )
    rtspStream = EntityDescription(
        id=auto(), icon="mdi:movie", category=EntityCategory.CONFIG
    )
    light = EntityDescription(
    ...
    speaker = EntityDescription(
        id=auto(), icon="mdi:volume-high", category=EntityCategory.CONFIG
    )
    audioRecording = EntityDescription(
        id=auto(), icon="mdi:record-circle", category=EntityCategory.CONFIG
    )
    loiteringDetection = EntityDescription(id=auto(), category=EntityCategory.CONFIG)
    motionDetectionTypePet = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    motionDetectionTypeVehicle = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    motionDetectionTypeHuman = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    motionDetectionTypeHumanRecognition = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    motionDetectionTypeAllOtherMotions = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    ...
    # device select
    powerSource = EntityDescription(
        id=auto(), icon="mdi:power-plug", category=EntityCategory.DIAGNOSTIC
    )
    ...
    chimeHomebaseRingtoneVolume = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    motionDetectionType = EntityDescription(id=auto(), category=EntityCategory.CONFIG)
    motionDetectionSensitivity = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    speakerVolume = EntityDescription(id=auto(), category=EntityCategory.CONFIG)
    nightvision = EntityDescription(
        id=auto(), icon="mdi:shield-moon", category=EntityCategory.CONFIG
    )
    lightSettingsManualLightingActiveMode = EntityDescription(
        id=auto(), icon="mdi:cog-play", category=EntityCategory.CONFIG
    )
    lightSettingsBrightnessManual = EntityDescription(
        id=auto(), icon="mdi:brightness-percent", category=EntityCategory.CONFIG
    )
    lightSettingsManualDailyLighting = EntityDescription(
        id=auto(), category=EntityCategory.CONFIG
    )
    ...
    promptVolume = EntityDescription(
        id=auto(), icon="mdi:volume-medium", category=EntityCategory.CONFIG
    )
    alarmVolume = EntityDescription(
        id=auto(), icon="mdi:volume-medium", category=EntityCategory.CONFIG
    )
    ...
    # lock sensor
    wrongTryProtectAlert = EntityDescription(
        id=auto(), category=EntityCategory.DIAGNOSTIC
    )
...
class PlatformToPropertyType(Enum):
    ...
    SENSOR = MetadataFilter(
        readable=True, writeable=False, types=[PropertyType.number, PropertyType.string]
    )
    BINARY_SENSOR = MetadataFilter(
    ...
    SELECT = MetadataFilter(
        readable=True,
        writeable=True,
        types=[PropertyType.number],
        any_fields=[MessageField.STATES.value],
    )
    NUMBER = MetadataFilter(
        readable=True,
        writeable=True,
        types=[PropertyType.number],
